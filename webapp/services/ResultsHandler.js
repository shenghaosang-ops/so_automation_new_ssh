...
sap.ui.define([], function() {
    ...
    var ResultsHandler = {
        ...
        processBatchResponse: function(ctrl, oApiResponse, iBatchStartIndex) {
            ...
            var fieldMappings = {
                "C001": { customerCode: "CustomerPurchaseCode", poNumber: "PONo", poDate: "PODate", itemNo: "POItemNo", poLine: "PO+POLINE", companyCode: "CompanyCode", customerPartNo: "CustomerPartNO", quantity: "QTY", requestDate: "RequestDate", netPrice: "NetPrice", partNo: "PartNo", salesOrderType: "SalesOrderType" },
                "C002": { vendorNo: "Vendor NO", customerCode: "Vendor NO", poNumber: "PO Number", poDate: "PO Date", itemNo: "Item No", companyCode: "CompanyCode", deliveryDate: "Delivery Date", requestDate: "Delivery Date", quantity: "Quantity", orderQty: "Order Qty", customerPartNo: "Manuf. P/N", partNo: "Part No", plant: "Plant", shipTo: "Ship To", soldTo: "Sold To", crd: "CRD", orderType: "Order Type", salesOrderType: "SalesOrderType" }
            };
